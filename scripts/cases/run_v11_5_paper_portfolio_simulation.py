...
sim={"status":"V11_5_PAPER_PORTFOLIO_SIMULATION_BUILT","simulation_mode":"PAPER_ONLY","portfolio_count":len(eligible),"results":results,"null_return_count":null_return_count,"blocked_result_count":blocked_result_count,"calculated_result_count":calculated_result_count,"missing_label_count":missing_label_count,"ready_for_alpha_claim":False,"alpha_validated":False,"production":"BLOCKED","broker_runtime":"BLOCKED","real_trade":"BLOCKED"}
