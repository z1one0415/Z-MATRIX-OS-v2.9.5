"""V13.5.13 Decay After 20D Monitor — tests."""
...
m=L("v13_5_13_decay_after_20d_monitor.json")
def test_exists():assert m
def test_monitored():assert m.get("monitored_months_40d",0)+m.get("monitored_months_60d",0)>0
