"""Stage F: Audit V13.F5.5.4.1 Signal Materialization Safety."""
import json
...
ISOLATION = OUT / "v13_f5_5_4_1_signal_isolation_audit.json"
...
def main():
    ...
    audit = {
        "pipeline_signature": "Z2-V13-F5-5-4-1-SIGNAL-MATERIALIZATION-SAFETY-AUDIT",
        "status": "V13_F5_5_4_1_SAFETY_AUDIT_PASS",
        "base_commit": "7384266",
        "checks": {
    ...
    (OUT / "v13_f5_5_4_1_signal_materialization_safety_audit.json").write_text(
