...
- `CompositionNode` data class with 10 required fields
...
- `CompositionEdge` data class with 10 required fields
...
- Max depth = 2, max node count = 2 enforcement
...
- Monotonic non-increasing propagation
...
- Node/edge/decision hash computation
...
- Degradation propagation downstream

### 2.8 Loop Prevention Implementation Spec
- Depth counter: max 2
- Cycle detection: Kahn's algorithm
- Self-edge rejection
- No dynamic recursion or hidden agent loops
...
- No >2 node graphs or >2 depth graphs
