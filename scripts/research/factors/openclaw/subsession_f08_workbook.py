...
FID = "F08"
FNAME = "CASH_FLOW_YIELD_LIGHT"
FFAMILY = "YIELD"
FORMULA = "cash_flow_yield = ocfps / close_price"
HYPOTHESIS = "high cash flow yield stocks outperform"
DATA_SOURCES = ["fundamentals", "price_bars"]
HORIZONS = ["20D", "60D"]
DIAGNOSTICS = ["coverage", "disclosure_freshness"]
...
wj("f08_single_factor_validation.json", {
...
wj("f08_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F08] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
