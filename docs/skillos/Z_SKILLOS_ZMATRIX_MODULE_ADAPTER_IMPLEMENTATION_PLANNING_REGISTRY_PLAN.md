# A1 Factor-Aligned — REGISTRY
## Status: Z_SKILLOS_ZMATRIX_MODULE_ADAPTER_IMPLEMENTATION_PLANNING_REGISTRY_PLAN_READY
...
## Scope: REGISTRY for Z-MATRIX module adapter. Factor-aligned. Dependency: FactorLib bridge.
