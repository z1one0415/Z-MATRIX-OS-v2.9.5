# A1 Factor-Aligned — SCOPE
## Status: Z_SKILLOS_ZMATRIX_MODULE_ADAPTER_IMPLEMENTATION_PLANNING_SCOPE_READY
...
## Scope: SCOPE for Z-MATRIX module adapter. Factor-aligned. Dependency: FactorLib bridge.
