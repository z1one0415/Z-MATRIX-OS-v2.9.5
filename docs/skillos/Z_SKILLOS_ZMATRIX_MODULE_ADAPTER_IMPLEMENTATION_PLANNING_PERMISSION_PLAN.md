# A1 Factor-Aligned — PERMISSION
## Status: Z_SKILLOS_ZMATRIX_MODULE_ADAPTER_IMPLEMENTATION_PLANNING_PERMISSION_PLAN_READY
...
## Scope: PERMISSION for Z-MATRIX module adapter. Factor-aligned. Dependency: FactorLib bridge.
