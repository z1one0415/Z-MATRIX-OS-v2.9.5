...
panel_path = BATCH / "f04_panel.csv"
...
wj("f04_single_factor_validation.json", {
...
wj("f04_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F04] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
