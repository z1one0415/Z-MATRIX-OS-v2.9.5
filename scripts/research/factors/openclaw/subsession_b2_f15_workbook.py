...
panel_path = BATCH / "f15_panel.csv"
...
wj("f15_single_factor_validation.json", {
...
wj("f15_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F15] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
