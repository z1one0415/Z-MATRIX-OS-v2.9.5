# A1 Factor-Aligned — READONLY_POLICY
## Status: Z_SKILLOS_ZMATRIX_MODULE_ADAPTER_IMPLEMENTATION_PLANNING_READONLY_POLICY_PLAN_READY
...
## Scope: READONLY_POLICY for Z-MATRIX module adapter. Factor-aligned. Dependency: FactorLib bridge.
