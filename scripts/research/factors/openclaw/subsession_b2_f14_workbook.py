...
panel_path = BATCH / "f14_panel.csv"
...
wj("f14_single_factor_validation.json", {
...
wj("f14_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F14] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
