# A1 Factor-Aligned — CONTRACT
## Status: Z_SKILLOS_ZMATRIX_MODULE_ADAPTER_IMPLEMENTATION_PLANNING_CONTRACT_PLAN_READY
...
## Scope: CONTRACT for Z-MATRIX module adapter. Factor-aligned. Dependency: FactorLib bridge.
