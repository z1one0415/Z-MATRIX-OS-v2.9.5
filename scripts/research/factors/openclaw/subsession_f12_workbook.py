...
FID = "F12"
FNAME = "VALUE_COMPOSITE_LIGHT"
FFAMILY = "VALUE"
FORMULA = "value_score = rank(bps/price) + rank(eps/price)"
HYPOTHESIS = "cheap stocks outperform expensive stocks"
PRIORITY = "P1"
DATA_SOURCES = ["fundamentals", "price_bars"]
HORIZONS = ["20D", "60D"]
DIAGNOSTICS = ["reporting_freshness", "coverage"]
...
wj("f12_single_factor_validation.json", {
...
wj("f12_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F12] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
