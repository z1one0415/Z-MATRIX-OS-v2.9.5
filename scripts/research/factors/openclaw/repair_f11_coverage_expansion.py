#!/usr/bin/env python3
"""V13.F3.0.1 — Coverage expansion for F04 SHORT_TERM_REVERSAL."""
import csv, json, sys
    ...
    if len(lines) > 2:
        ...
        for rebal_month in ["202601", "202602", "202603", "202604", "202605"]:
            ...
            panel_rows.append({
                ...
                "factor_id": FID, "factor_name": "SHORT_TERM_REVERSAL",
...
panel_path = BATCH / "f11_coverage_expanded_panel.csv"
...
wj("f11_coverage_expansion_repair.json", repair)
