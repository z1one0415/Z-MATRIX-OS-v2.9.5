"""Tests for V13.F5.5.2.2 Seven-Factor Safety."""
import json
...
def test_safety_pass():
    s = _l("v13_f5_5_2_2_seven_factor_safety_audit.json")
    assert s["status"] == "V13_F5_5_2_2_SAFETY_AUDIT_PASS"
    assert s["violation_count"] == 0

def test_monitoring_executed():
    s = _l("v13_f5_5_2_2_seven_factor_safety_audit.json")
    assert s["checks"]["seven_factor_partial_monitoring_executed"] is True
