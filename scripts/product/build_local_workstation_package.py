...
REQUIRED_FILES = (
    ...
    "scripts/product/bootstrap_local_workstation.sh",
    "scripts/product/check_product_readiness.py",
...
def _copy_runtime_files(root: Path, output_dir: Path) -> list[str]:
    mapping = {
        ...
        "scripts/product/bootstrap_local_workstation.sh": output_dir / "runtime" / "bootstrap_local_workstation.sh",
    ...
    *,
    ...
    return {
        ...
        "operator_entrypoints": {
            "bootstrap": "bash scripts/product/bootstrap_local_workstation.sh",
            "bootstrap_check": "bash scripts/product/bootstrap_local_workstation.sh --check",
            ...
            "product_readiness": "PYTHONPATH=. python3 scripts/product/check_product_readiness.py",
...
def _write_start_here(output_dir: Path) -> None:
    lines = [
        ...
        "2. Run `bash scripts/product/bootstrap_local_workstation.sh` from the source workspace.",
        "3. Configure local-only environment values in `.env`.",
