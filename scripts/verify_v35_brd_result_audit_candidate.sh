...
echo ""; echo "== Backward =="; bash scripts/verify_v35_brd_5y_strategy_validation_candidate.sh || true
echo ""; echo "== Audit Smoke =="; PYTHONPATH=. python3 scripts/run_v35_brd_result_audit.py || true
echo ""; echo "== Git check =="
