# A1 Factor-Aligned — PRIORITY_WAVE
## Status: Z_SKILLOS_ZMATRIX_MODULE_ADAPTER_IMPLEMENTATION_PLANNING_PRIORITY_WAVE_PLAN_READY
...
## Scope: PRIORITY_WAVE for Z-MATRIX module adapter. Factor-aligned. Dependency: FactorLib bridge.
