...
SHARED_SKILL_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "brd_result_audit.market_distribution.build": {"layer":"shared_skill","module":"zmatrix.brd_result_audit.market_role_distribution","public_function":"build_market_role_distribution_report","owner":"BRDAudit","used_by":["Z-V35BRDResultAudit"],"contract":"docs/contracts/BRD_MARKET_ROLE_DISTRIBUTION_V10.md","test":"tests/test_brd_result_audit_distribution.py","duplicate_allowed":False,"safety_boundary":"audit-only, no real trade"},
    "brd_result_audit.b_matrix.explain": {"layer":"shared_skill","module":"zmatrix.brd_result_audit.b_matrix_explainer","public_function":"explain_b_matrix_result","owner":"BRDAudit","used_by":["Z-V35BRDResultAudit"],"contract":"docs/contracts/B_MATRIX_EXPLAIN_V10.md","test":"tests/test_b_matrix_explainer.py","duplicate_allowed":False,"safety_boundary":"explain-only, no real trade"},
    "brd_result_audit.active_outcome.validate": {"layer":"shared_skill","module":"zmatrix.brd_result_audit.active_outcome_validator","public_function":"validate_active_outcomes","owner":"BRDAudit","used_by":["Z-V35BRDResultAudit"],"contract":"docs/contracts/ACTIVE_OUTCOME_VALIDATOR_V10.md","test":"tests/test_active_outcome_validator.py","duplicate_allowed":False,"safety_boundary":"validation-only, no real trade"},
    "brd_result_audit.report.build": {"layer":"shared_skill","module":"zmatrix.brd_result_audit.audit_report_builder","public_function":"build_brd_result_audit_report","owner":"BRDAudit","used_by":["Z-V35BRDResultAudit"],"contract":"docs/contracts/BRD_RESULT_AUDIT_REPORT_V10.md","test":"tests/test_brd_result_audit_report.py","duplicate_allowed":False,"safety_boundary":"audit-report-only, no real trade"},
}
