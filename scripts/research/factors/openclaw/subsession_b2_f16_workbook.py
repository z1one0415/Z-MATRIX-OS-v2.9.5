...
panel_path = BATCH / "f16_panel.csv"
...
wj("f16_single_factor_validation.json", {
...
wj("f16_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F16] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
