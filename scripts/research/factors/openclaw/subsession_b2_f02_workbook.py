...
panel_path = BATCH / "f02_panel.csv"
...
wj("f02_single_factor_validation.json", {
...
wj("f02_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F02] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
