"""Executable formula for F14 ASSET_GROWTH_DISCIPLINE.

Factor type: FUNDAMENTAL_QUALITY
Formula: -or_yoy (lower revenue growth = more disciplined)
...
def compute_signal(input_prices, rebalance_date):
    """Compute F14 ASSET_GROWTH_DISCIPLINE signal scores.
