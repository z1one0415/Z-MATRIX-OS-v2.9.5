...
for r in["zmatrix","scripts","tests/agent","data/research_db/agent/registry"]:
    ...
    for f in p.rglob("*"):
        ...
        skip={"scripts/verify_z_skillos_v09.sh","zmatrix/investment/account_constitution.py","zmatrix/hermes_kernel/prompt_patch_preview.py","zmatrix/hermes_kernel/prompt_patch_audit.py","zmatrix/hermes_kernel/prompt_patch_request.py","zmatrix/research_council/reviewers.py","zmatrix/research_council/council.py"}
