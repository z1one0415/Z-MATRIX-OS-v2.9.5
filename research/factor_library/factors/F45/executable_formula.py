"""Executable formula for F45 CAPACITY_UTILIZATION_PRESSURE.

Factor type: OPERATING_CYCLE
Formula: z(asset_turnover)-z(fix_assets_growth)
Source: tushare balancesheet+income
...
def compute_signal(input_prices, rebalance_date):
    """Compute F45 CAPACITY_UTILIZATION_PRESSURE signal scores.
