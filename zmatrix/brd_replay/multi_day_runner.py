...
def run_multi_day_brd_strategy_replay(*, replay_dates, local_data_root, max_tickers=None, benchmark_code=None, classifier=None):
    daily, failures = [], []
    for d in replay_dates or []:
        try: daily.append(run_single_day_brd_strategy_replay(replay_date=d,local_data_root=local_data_root,max_tickers=max_tickers,benchmark_code=benchmark_code,classifier=classifier))
