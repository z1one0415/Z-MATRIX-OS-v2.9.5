...
- build_approval_request_event → ApprovalRequestEvent (NOT MemoryCandidateEvent)
- build_human_approval_event → HumanApprovalEvent
- Both do NOT append, write Hermes, or write Z9
"""
...
def build_approval_request_event(approval_request: dict) -> dict:
    """Build an ApprovalRequestEvent from an approval request.
    ...
    payload = {
        ...
        "source_preview_hash": approval_request.get("source_preview_hash", ""),
