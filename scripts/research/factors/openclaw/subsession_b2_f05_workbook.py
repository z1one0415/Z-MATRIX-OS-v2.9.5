...
panel_path = BATCH / "f05_panel.csv"
...
wj("f05_single_factor_validation.json", {
...
wj("f05_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F05] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
