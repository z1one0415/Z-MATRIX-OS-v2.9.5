...
FID = "F11"
FNAME = "SHORT_TERM_REVERSAL"
FFAMILY = "REVERSAL"
FORMULA = "short_term_reversal_score = -return_5d"
HYPOTHESIS = "short-term winners tend to reverse over next weeks"
PRIORITY = "P0"
DATA_SOURCES = ["price_bars"]
HORIZONS = ["5D", "20D", "60D"]
DIAGNOSTICS = ["turnover_cost_30bps", "turnover_cost_50bps", "crowding_check"]
...
panel_path = BATCH / "f11_panel.csv"
...
wj("f11_single_factor_validation.json", {
...
wj("f11_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F11] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
