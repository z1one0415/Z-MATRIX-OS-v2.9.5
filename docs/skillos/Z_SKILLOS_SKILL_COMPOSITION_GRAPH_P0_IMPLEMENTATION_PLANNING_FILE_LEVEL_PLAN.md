...
Level 1 (Depends on Level 0):
  models/edge.py (→ models/node.py)

Level 2 (Depends on Level 0-1):
  models/graph.py (→ models/node.py, models/edge.py)

Level 3 (Depends on Level 2):
  validators/dag_validator.py (→ models/graph.py)
  validators/permission_validator.py (→ models/node.py, models/edge.py)
  validators/evidence_validator.py (→ models/node.py, models/edge.py, models/graph.py)

Level 4 (Depends on Level 3):
  policies/permission_propagation.py (→ validators/permission_validator.py)
  policies/evidence_propagation.py (→ validators/evidence_validator.py)
  policies/loop_prevention.py (→ validators/dag_validator.py)
  policies/output_boundary.py (→ models/edge.py)

Level 5 (Depends on Level 2):
  degradation/degradation_controller.py (→ models/graph.py)

Level 6 (Depends on all):
  tests/test_composition_graph.py (→ all modules)
```
