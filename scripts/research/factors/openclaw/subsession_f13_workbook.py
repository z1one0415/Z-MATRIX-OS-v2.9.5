...
FID = "F13"
FNAME = "SHAREHOLDER_YIELD_LIGHT"
FFAMILY = "YIELD"
FORMULA = "shareholder_yield = dividend_yield_proxy - dilution_proxy"
HYPOTHESIS = "companies returning cash to shareholders outperform"
DATA_SOURCES = ["fundamentals", "corporate_action"]
HORIZONS = ["20D", "60D"]
DIAGNOSTICS = ["source_readiness", "dividend_coverage"]
...
wj("f13_single_factor_validation.json", {
...
wj("f13_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F13] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
