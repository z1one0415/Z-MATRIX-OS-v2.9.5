...
"Z-TailRisk.autonomic_gates_preview_workflow": {
        ...
        "edges": [
            ("tail.market_signals.normalize", "tail.limit_down_blackhole.evaluate"),
            ("tail.market_signals.normalize", "tail.domestic_liquidity_crash.evaluate"),
            ("tail.market_signals.normalize", "tail.hibernate_mode.evaluate"),
            ("tail.hibernate_mode.evaluate", "tail.wakeup_probation.evaluate"),
            ("tail.domestic_liquidity_crash.evaluate", "tail.d_matrix_freeze.evaluate"),
            ("tail.limit_down_blackhole.evaluate", "tail.risk_isolation.preview"),
            ("tail.risk_isolation.preview", "tail.controller.preview"),
            ("tail.d_matrix_freeze.evaluate", "tail.controller.preview"),
            ("tail.controller.preview", "tail.policy.validate"),
            ("tail.policy.validate", "tail.controller_event.build"),
            ("tail.controller_event.build", "tail.gate_event.build"),
            ("tail.gate_event.build", "tail.isolation_event.build"),
            ("tail.isolation_event.build", "safety.no_real_trade"),
        ],
        "required_gates": [
        ...
        "contract": "docs/architecture/TAIL_RISK_AUTONOMIC_GATES_PREVIEW_V10.md",
