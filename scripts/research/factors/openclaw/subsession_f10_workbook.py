...
FID = "F10"
FNAME = "LOW_VOLATILITY"
FFAMILY = "RISK"
FORMULA = "low_volatility_score = -std(daily_return, 60D)"
HYPOTHESIS = "low volatility stocks outperform high volatility stocks on risk-adjusted basis"
PRIORITY = "P0"
DATA_SOURCES = ["price_bars"]
HORIZONS = ["20D", "60D"]
DIAGNOSTICS = ["down_market_protection", "volatility_regime_split"]
...
panel_path = BATCH / "f10_panel.csv"
...
wj("f10_single_factor_validation.json", {
...
wj("f10_evidence_scorecard.json", {
    "factor_id": FID, "factor_name": FNAME,
    "evidence_score": evidence,
...
print(f"[F10] Complete. evidence={evidence} sample={sample_months}m")
sys.exit(0)
