...
def route_skill(sid,env,ctx):
    ...
    if sid=="FACTOR.GET_FACTOR_READINESS":
        o=_sb(); o.update({"readiness":"READ_ONLY_READY","engine":False,"calc":False,"backtest":False,"signal":False}); return build_skill_success(sid,o)
