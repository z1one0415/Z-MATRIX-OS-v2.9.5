"""Executable formula for F51 MACRO_HEADWIND_RISK.

Factor type: POLICY_MACRO
Formula: rate_change+m2_deceleration
Source: tushare cn_m+shibor_lpr
...
def compute_signal(input_prices, rebalance_date):
    """Compute F51 MACRO_HEADWIND_RISK signal scores.
