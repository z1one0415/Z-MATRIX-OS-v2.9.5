...
echo "[3] Product readiness"
PYTHONPATH=. python3 scripts/product/check_product_readiness.py >/tmp/zmatrix_product_readiness.json

echo "[4] Cockpit packet export"
PYTHONPATH=. python3 scripts/cockpit/export_all_packets.py >/tmp/zmatrix_cockpit_packet_export.json

echo "[5] Local vendor dry plan"
